...
export default function App(){
  ...
  return(
    <div style={{minHeight:"100vh",background:"var(--color-background-tertiary)",fontFamily:"'DM Sans',system-ui,sans-serif"}}>
          ...
          {!mobile&&(
            <nav style={{background:"#ffffff",borderBottom:"0.5px solid #e5e7eb",position:"fixed",top:0,left:0,right:0,zIndex:9999,height:56}}>
              <div style={{maxWidth:1280,margin:"0 auto",padding:"0 1.5rem",display:"flex",alignItems:"center",gap:"1rem",height:"100%"}}>
                <span style={{fontSize:18,fontWeight:700,letterSpacing:"-0.04em",color:C.blue,cursor:"pointer",marginRight:"auto"}} onClick={()=>navigateTo("home")}>Mundialist</span>
                {NAV.map(({label,page:p})=>(
                  <button key={p} onClick={()=>navigateTo(p)} style={{background:"none",border:"none",cursor:"pointer",fontSize:13,
          ...
          {mobile&&(
            <nav style={{background:"#ffffff",borderBottom:"0.5px solid #e5e7eb",position:"fixed",top:0,left:0,right:0,zIndex:9999,height:48}}>
              <div style={{padding:"0 1rem",display:"flex",alignItems:"center",justifyContent:"space-between",height:"100%"}}>
                <span style={{fontSize:16,fontWeight:700,letterSpacing:"-0.04em",color:C.blue,cursor:"pointer"}} onClick={()=>navigateTo("home")}>Mundialist</span>
          ...
          {mobile&&(
            <nav style={{background:"#ffffff",borderTop:"0.5px solid #e5e7eb",position:"fixed",bottom:0,left:0,right:0,zIndex:9999,display:"flex",alignItems:"stretch",paddingBottom:"env(safe-area-inset-bottom)",minHeight:56}}>
              {[
                ...
                <button key={p} onClick={()=>navigateTo(p)} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:2,background:"none",border:"none",cursor:"pointer",padding:"8px 0"}}>
            ...
            <div style={{maxWidth:700,margin:"0 auto",width:"100%",position:"relative",zIndex:1}}>
              ...
              <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:"2rem"}}>
                ...
                <div style={{display:"flex",alignItems:"center",padding:"0 4px"}}>
                  <button onClick={()=>navigateTo("points")} style={{background:"none",border:"none",cursor:"pointer",fontSize:12,color:"rgba(255,255,255,0.5)",textDecoration:"underline"}}>see all scoring →</button>
                </div>
              </div>
              ...
              {!user?(
                ...
                <div style={{background:"rgba(255,255,255,0.1)",border:"0.5px solid rgba(255,255,255,0.2)",borderRadius:12,padding:"1rem 1.5rem",display:"flex",alignItems:"center",gap:12,maxWidth:460}}>
                  ...
                  <button onClick={()=>navigateTo("predict")} style={{marginLeft:"auto",padding:"8px 18px",background:C.gold,color:"#fff",border:"none",borderRadius:8,fontSize:13,fontWeight:600,cursor:"pointer",whiteSpace:"nowrap"}}>Continue →</button>
                </div>
              )}
            </div>
          </div>
        ...
        <div style={{maxWidth:1400,margin:"0 auto",padding:"2rem 1.5rem"}}>
          <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",flexWrap:"wrap",gap:10,marginBottom:"1.5rem"}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:8,alignItems:"flex-end",flexShrink:0}}>
              ...
              <div style={{display:"flex",gap:8}}>
                ...
                <button onClick={()=>navigateTo("predict")} style={{padding:"8px 14px",border:"0.5px solid var(--color-border-tertiary)",borderRadius:8,background:"var(--color-background-primary)",fontSize:12,color:"var(--color-text-secondary)",cursor:"pointer"}}>← Group stage</button>
              </div>
            </div>
          </div>
          ...
          {r32AllTBD&&(
            <div style={{display:"flex",gap:12,padding:"14px 18px",background:C.blueLt,border:`0.5px solid ${C.blue}`,borderRadius:10,marginBottom:"1.5rem",alignItems:"center"}}>
              ...
              <button onClick={()=>navigateTo("predict")} style={{marginLeft:"auto",padding:"8px 16px",background:C.blue,color:"#fff",border:"none",borderRadius:8,fontSize:13,fontWeight:500,cursor:"pointer",whiteSpace:"nowrap",flexShrink:0}}>Go to Group Stage →</button>
            </div>
          )}
            ...
            <div style={{display:"flex",alignItems:"stretch",minWidth:1050,gap:0}}>
              ...
              <div style={{display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",width:172,flexShrink:0,gap:8}}>
                ...
                <div style={{marginTop:16,width:"100%"}}>
                  ...
                  <KOCard home={thirdPlaceMatchup.home} away={thirdPlaceMatchup.away} picked={koPicks.third} onPick={t=>{setKoPicks(prev=>({...prev,third:t}));saveKOPick('third',0,t);}} label="3rd place" actualWinner={getKOWinner(thirdPlaceMatchup.home,thirdPlaceMatchup.away)} roundKey="third" venue={KO_VENUES.third?.venue} city={KO_VENUES.third?.city}/>
      ...
      {page==="terms"&&(
        <div style={{maxWidth:640,margin:"0 auto",padding:"2rem 1.5rem"}}>
          <button onClick={()=>navigateTo("home")} style={{background:"none",border:"none",cursor:"pointer",fontSize:13,color:"var(--color-text-secondary)",marginBottom:"1rem",padding:0}}>← Back</button>
      ...
      {/* Footer */}
      <footer style={{marginTop:"3rem",borderTop:"0.5px solid var(--color-border-tertiary)",background:"var(--color-background-primary)",paddingBottom:"env(safe-area-inset-bottom)"}}>
        ...
        <div style={{maxWidth:1200,margin:"0 auto",padding:"1.25rem 2rem",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          ...
          <div style={{display:"flex",gap:"1.5rem"}}>
            ...
            <button onClick={()=>navigateTo("terms")} style={{background:"none",border:"none",cursor:"pointer",fontSize:12,color:"var(--color-text-tertiary)",padding:0}}>Terms</button>
          </div>
        </div>
      </footer>
    </div>
